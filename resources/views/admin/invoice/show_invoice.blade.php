...
<head>
    ...
    <title>Invoice Hossam Store</title>
...
<table class="order-details">
    ...
    <tr>
        <th width="50%" colspan="2">
            <h2 class="text-start">Hossam Store</h2>
        </th>
        <th width="50%" colspan="2" class="text-end company-data">
            <span>Invoice Id: {{$order->id}}</span> <br>
            <span>Date: {{ optional($order->created_at)->format('d-m-Y h:i A') }}</span> <br>
...
<br>
<p class="text-center">
    Thank your for shopping with Hossam Store
</p>
